...
for segment in segments:
    ...
    GPIO.output(22, 1) #Off initially
    #Digit 2
    GPIO.setup(27, GPIO.OUT)
    GPIO.output(27, 1) #Off initially
    #Digit 3
    GPIO.setup(17, GPIO.OUT)
    GPIO.output(17, 1) #Off initially
    #Digit 4
    GPIO.setup(24, GPIO.OUT)
    GPIO.output(24, 1) #Off initially
...
while 1:
    ...
    GPIO.output(22, 0) #Turn on Digit One
    print_segment (h1) #Print h1 on segment
    time.sleep(delay_time)
    GPIO.output(22, 1) #Turn off Digit One
 
    GPIO.output(27, 0) #Turn on Digit One
    print_segment (h2) #Print h1 on segment
    GPIO.output(25, 1) #Display point On
    time.sleep(delay_time)
    GPIO.output(25, 0) #Display point Off
    GPIO.output(27, 1) #Turn off Digit One
 
    GPIO.output(17, 0) #Turn on Digit One
    print_segment (m1) #Print h1 on segment
    time.sleep(delay_time)
    GPIO.output(17, 1) #Turn off Digit One
 
    GPIO.output(24, 0) #Turn on Digit One
    print_segment (m2) #Print h1 on segment
    time.sleep(delay_time)
    GPIO.output(24, 1) #Turn off Digit One
